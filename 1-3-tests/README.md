...
Here we assume that you followed the [first tutorial](../1-1-create-and-deploy-1/README.md) and understand the concepts of messages, working with data, and the [deployment process](../1-2-create-and-deploy-2/README.md). If you don't, please follow the first tutorial and come back when you're comfortable with these concepts.
